...
const STUDENTS: Array<{ name: string; shape: FlowerShape; body: string }> = [
  ...
  { name: '박서연', shape: 'daisy',     body: '힘들 때마다 따뜻한 말 한마디가 큰 힘이 됐어요. 평생 기억할게요.' },
  { name: '도현',   shape: 'tulip',     body: '수업 시간이 진짜 기다려졌어요. 선생님 같은 어른이 되고 싶어요!' },
  { name: '하윤',   shape: 'clover',    body: '진로 고민 들어주셔서 감사해요. 덕분에 결심했어요. 잊지 않을게요.' },
  { name: '시우',   shape: 'sunflower', body: '선생님 농담 진짜 재미있었어요 ㅋㅋ 보고 싶을 거예요 🌻' },
  { name: '예준',   shape: 'carnation', body: '시험 망쳤을 때 다시 일어설 수 있게 해주셔서 정말 감사합니다.' },
  { name: '윤서',   shape: 'daisy',     body: '매일 아침 환하게 웃으며 인사 받아주신 거, 그게 정말 큰 힘이었어요.' },
  { name: '한주원', shape: 'tulip',     body: '제가 자신감이 생긴 건 다 선생님 덕분이에요. 감사합니다 🌿' },
  { name: '강하준', shape: 'clover',    body: '좋은 어른이 되라는 말씀, 마음에 새겼습니다. 부끄럽지 않은 사람 될게요.' },
  { name: '서아',   shape: 'sunflower', body: '선생님 같은 선생님 다시 만날 수 있을까요? 너무 감사드려요.' },
